...
async function handleUpload(itemId) {
    ...
    input.onchange = async () => {
        ...
        try {
            ...
            console.log('Ruta de la API:', `https://9816-186-114-123-249.ngrok-free.app/items/${itemId}/upload`);
            console.log('Archivo seleccionado:', file);

            const response = await fetch(`https://9816-186-114-123-249.ngrok-free.app/items/${itemId}/upload`, {
                method: 'POST',
                body: formData,
            });
...
function addItem(event) {
    ...
    fetch('https://9816-186-114-123-249.ngrok-free.app/items', {
        method: 'POST',
        headers: {
...
fetch(`https://9816-186-114-123-249.ngrok-free.app/items?correo=${encodeURIComponent(userEmail)}`, {
    method: 'GET',
    headers: {
